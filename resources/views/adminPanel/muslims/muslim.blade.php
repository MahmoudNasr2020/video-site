...
@section('content')
    <div class="row">
        ...
        <div class="card">
            ...
            <h4 class="card-title ">muslims</h4>
            <p class="card-category"> Here Showing All muslims</p>
            </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="" class="btn btn-primary btn-round add" style="background-color: #913f9e !important;float:right;border-radius:0">Add Muslim
    ...
    @include('adminPanel.muslims.modals.form')
...
{!! $dataTable->scripts() !!}
@include('adminPanel.muslims.ajaxaction.script')
