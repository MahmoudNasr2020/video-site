...
@section('content')
    <div class="row">
        ...
        <div class="card">
            ...
            <p class="card-category"> Here Showing All Videos</p>
            </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="" class="btn btn-primary btn-round add" style="background-color: #913f9e !important;float:right;border-radius:0">Add Video
    ...
    @include('adminPanel.videos.modals.form')
...
{!! $dataTable->scripts() !!}
@include('adminPanel.videos.ajaxaction.script')
